...
const PostActions = ({ postId, postTitle, timeAgo, onCommentClick }) => {
  return (
    <div className="flex justify-between items-center cursor-pointer">
      <div className="flex items-center gap-3">
        <div className="relative group">
          <button className="flex items-center gap-1 cursor-pointer text-gray-600 hover:text-red-500 transition-colors">
        ...
        <div className="relative group">
          <button
            onClick={() => onCommentClick(postId, postTitle)}
      ...
      <div className="flex items-center justify-between">
        <span className="text-blue-600 font-semibold text-sm cursor-pointer">Read more</span>
      </div>
    </div>
  );
};
